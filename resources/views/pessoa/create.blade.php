...
<div class="col-md-6">
    <form action="{{route('pessoa.store')}}" method="post" class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="nome" value="{{old('nome')}}" name="nome" placeholder="Nome Completo">
            </div>
        </div>
        <div class="form-group">
            <label for="apelido" class="col-sm-2 control-label">Apelido</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="apelido"  value="{{old('apelido')}}" name="apelido" placeholder="Apelido">
            </div>
        </div>
        <div class="form-group">
